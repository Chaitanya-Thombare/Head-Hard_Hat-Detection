    ...
    if obj_class == 'helmet':
        if 0.5 <= conf < 0.70:
            cv2.rectangle(img, (left, top), (right, bottom), (0, 255, 255), 3)
                ...
                cv2.rectangle(img, (left, top), (right, bottom), (0, 128, 255), 3)
        elif 0.9 <= conf:
        ...
        if 0.5 <= conf < 0.70:
            cv2.rectangle(img, (left, top), (right, bottom), (255, 255, 255), 3)
                ...
                cv2.rectangle(img, (left, top), (right, bottom), (128, 128, 128), 3)
        elif 0.9 <= conf:
                cv2.rectangle(img, (left, top), (right, bottom), (0, 0, 0), 3)
...
cap = cv2.VideoCapture('../media/vid.avi')
fourcc = 0x00000021
